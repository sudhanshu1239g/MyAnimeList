const AnimeCard = ({ anime }) => (
  <div className="group relative cursor-pointer overflow-hidden rounded-xl bg-gray-800 transition-all duration-500 hover:scale-105 hover:shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
